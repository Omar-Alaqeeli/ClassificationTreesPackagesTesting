...
dataset <- readRDS("datasets/GSE57872.rds")
...
#based on characteristics_ch1.1 factor (cell type: Glioblastoma & cell type: Gliomasphere Cell Line)
dataset <- dataset[1:864,]
#dim(dataset)
row.names(dataset)[1:672] <- "1"
row.names(dataset)[673:864] <- "0"
#dataset[1:3,1:10]
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE57872/speed_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE57872/auc_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE57872/precision_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE57872/complexity_table.csv")


pdf("~/Documents/R/GSE57872/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE57872/AUC.pdf")
...
pdf("~/Documents/R/GSE57872/Precision.pdf")
...
pdf("~/Documents/R/GSE57872/Complexity.pdf")

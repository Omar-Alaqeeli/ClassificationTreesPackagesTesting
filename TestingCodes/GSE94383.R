...
dataset <- readRDS("datasets/GSE94383.rds")
...
#based on "time point: 0" & "min  time point: 75 min"
dataset <- dataset[1:331,]

row.names(dataset)[1:186] <- "1"
row.names(dataset)[187:331] <- "0"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE94383/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE94383/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE94383/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE94383/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE94383/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE94383/complexity_table.csv")


pdf("~/Documents/R/GSE94383/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE94383/Precision.pdf")
...
pdf("~/Documents/R/GSE94383/Complexity.pdf")

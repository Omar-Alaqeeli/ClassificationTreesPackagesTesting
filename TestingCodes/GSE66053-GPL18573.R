...
setwd("~/Documents/R")
dataset <- readRDS("datasets/GSE66053-GPL18573.rds")
dataset <- updateObject(dataset)
table(colData(dataset)[,13])
colData(dataset)[,13]
...
#based on "Cells were added to the Fluidigm C1 Single Cell Auto Prep System at 200K cells/ml. ERCC control mix 1 was added at a dilution of 1:10,000" & "Fixed cells were added to the Fluidigm C1 Single Cell Auto Prep System at 200K cells/ml. ERCC control mix 1 was added at a dilution of 1:10,000"
dataset <- dataset[1:96,]

row.names(dataset)[1:5] <- "1"
row.names(dataset)[6:19] <- "0"
row.names(dataset)[20:96] <- "1"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE66053-GPL18573/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE66053-GPL18573/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE66053-GPL18573/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE66053-GPL18573/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE66053-GPL18573/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE66053-GPL18573/complexity_table.csv")


pdf("~/Documents/R/GSE66053-GPL18573/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE66053-GPL18573/Precision.pdf")
...
pdf("~/Documents/R/GSE66053-GPL18573/Complexity.pdf")

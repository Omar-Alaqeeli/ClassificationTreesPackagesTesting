...
dataset <- readRDS("datasets/GSE81903.rds")
...
#based on "retina id: 1Ra" & "retina id: 1la"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE81903/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE81903/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE81903/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE81903/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE81903/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE81903/complexity_table.csv")


pdf("~/Documents/R/GSE81903/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE81903/Precision.pdf")
...
pdf("~/Documents/R/GSE81903/Complexity.pdf")

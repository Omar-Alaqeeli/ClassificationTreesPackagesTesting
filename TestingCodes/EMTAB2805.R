...
recall_table
write.csv(recall_table, "~/Documents/R/EMTAB2805/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/EMTAB2805/F1score_table.csv")

...
dataset <- readRDS("datasets/GSE48968-GPL13112.rds")
...
#based on source_name_ch1 factor (BMDC (Unstimulated Replicate Experiment)) & BMDC (1h LPS Stimulation))

dataset <- dataset[1:191,]

row.names(dataset)[1:96] <- "1"
row.names(dataset)[97:191] <- "0"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE48968-GPL13112/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE48968-GPL13112/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE48968-GPL13112/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE48968-GPL13112/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE48968-GPL13112/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE48968-GPL13112/complexity_table.csv")


pdf("~/Documents/R/GSE48968-GPL13112/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE48968-GPL13112/Precision.pdf")
...
pdf("~/Documents/R/GSE48968-GPL13112/Complexity.pdf")

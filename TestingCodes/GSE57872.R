...
recall_table
write.csv(recall_table, "~/Documents/R/GSE57872/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE57872/F1score_table.csv")

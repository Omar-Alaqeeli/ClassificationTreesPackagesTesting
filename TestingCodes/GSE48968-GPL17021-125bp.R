...
dataset <- readRDS("datasets/GSE48968-GPL17021-125bp.rds")
...
#based on BMDC (On Chip 4h LPS Stimulation) & BMDC (2h IFN-B Stimulation)
dataset <- dataset[1:184,]
#dim(dataset)
row.names(dataset)[1:90] <- "1"
row.names(dataset)[91:184] <- "0"
#dataset[1:3,1:10]
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE48968-GPL17021-125bp/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE48968-GPL17021-125bp/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE48968-GPL17021-125bp/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE48968-GPL17021-125bp/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE48968-GPL17021-125bp/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE48968-GPL17021-125bp/complexity_table.csv")


pdf("~/Documents/R/GSE48968-GPL17021-125bp/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE48968-GPL17021-125bp/Precision.pdf")
...
pdf("~/Documents/R/GSE48968-GPL17021-125bp/Complexity.pdf")

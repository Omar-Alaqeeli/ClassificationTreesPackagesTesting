...
dataset <- readRDS("datasets/SRP073808.rds")
dataset <- updateObject(dataset)
table(colData(dataset)[,2])
colData(dataset)[,2]
...
#based on "H7hESC" & "H7_derived_APS"
dataset <- dataset[1:141,]

row.names(dataset)[1:77] <- "1"
row.names(dataset)[78:141] <- "0"
...
speed_table
write.csv(speed_table, "~/Documents/R/SRP073808/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/SRP073808/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/SRP073808/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/SRP073808/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/SRP073808/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/SRP073808/complexity_table.csv")


pdf("~/Documents/R/SRP073808/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/SRP073808/Precision.pdf")
...
pdf("~/Documents/R/SRP073808/Complexity.pdf")

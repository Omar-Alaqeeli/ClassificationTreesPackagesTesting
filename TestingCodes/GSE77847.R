...
dataset <- readRDS("datasets/GSE77847.rds")
dataset <- updateObject(dataset)
table(colData(dataset)[,10])
colData(dataset)[,10]
...
#based on "sample type: cKit+ Flt3ITD/ITD,Dnmt3afl/- MxCre  AML-1" & "sample type: cKit+ Flt3ITD/ITD,Dnmt3afl/- MxCre  AML-2"
dataset <- dataset[1:96,]


row.names(dataset)[1:48] <- "1"
row.names(dataset)[49:96] <- "0"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE77847/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE77847/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE77847/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE77847/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE77847/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE77847/complexity_table.csv")


pdf("~/Documents/R/GSE77847/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE77847/Precision.pdf")
...
pdf("~/Documents/R/GSE77847/Complexity.pdf")

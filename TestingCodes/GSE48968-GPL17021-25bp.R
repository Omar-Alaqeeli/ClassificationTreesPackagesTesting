...
dataset <- readRDS("datasets/GSE48968-GPL17021-25bp.rds")
dataset <- updateObject(dataset)
colData(dataset)[,12]
#head(colData(dataset))
table(colData(dataset)[,12])
(dataset <- experiments(dataset)[["gene"]])
dataset <- assays(dataset)[["TPM"]]
dataset <- t(dataset)
#dataset[1:3,1:3]

#based on stimulation: LPS4h, GolgiPlug 1h & stimulation: LPS4h, GolgiPlug 2h 
dataset <- dataset[1:99,]
#dim(dataset)
row.names(dataset)[1:46] <- "1"
row.names(dataset)[47:99] <- "0"
#dataset[1:3,1:10]
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE48968-GPL17021-25bp/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE48968-GPL17021-25bp/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE48968-GPL17021-25bp/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE48968-GPL17021-25bp/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE48968-GPL17021-25bp/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE48968-GPL17021-25bp/complexity_table.csv")


pdf("~/Documents/R/GSE48968-GPL17021-25bp/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE48968-GPL17021-25bp/Precision.pdf")
...
pdf("~/Documents/R/GSE48968-GPL17021-25bp/Complexity.pdf")

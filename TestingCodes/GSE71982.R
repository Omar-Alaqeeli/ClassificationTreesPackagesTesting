...
dataset <- readRDS("datasets/GSE71982.rds")
...
#based on "Vestibular epithelium" & "Cochlear epithelium"
dataset <- dataset[1:313,]
...
row.names(dataset)[1:160] <- "1"
row.names(dataset)[161:313] <- "0"
...
speed_table
write.csv(speed_table, "~/Documents/R/GSE71982/speed_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/GSE71982/precision_table.csv")

recall_table <- data.frame("rpart" = rpart_recall, "ctree" = ctree_recall, "evtree" = evtree_recall, "tree" = tree_recall, "C5.0" = C5.0_recall)
recall_table
write.csv(recall_table, "~/Documents/R/GSE71982/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE71982/F1score_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/GSE71982/auc_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/GSE71982/complexity_table.csv")


pdf("~/Documents/R/GSE71982/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/GSE71982/Precision.pdf")
...
pdf("~/Documents/R/GSE71982/Complexity.pdf")

...
recall_table
write.csv(recall_table, "~/Documents/R/GSE45719/recall_table.csv")
...
F1score_table
write.csv(F1score_table, "~/Documents/R/GSE45719/F1score_table.csv")

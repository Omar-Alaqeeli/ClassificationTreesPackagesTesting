...
dataset <- readRDS("datasets/EMTAB2805.rds")
...
speed_table
write.csv(speed_table, "~/Documents/R/EMTAB2805/speed_table.csv")

auc_table <- data.frame("rpart" = rpart_auc, "ctree" = ctree_auc, "evtree" = evtree_auc, "tree" = tree_auc, "C5.0" = C5.0_auc)
auc_table
write.csv(auc_table, "~/Documents/R/EMTAB2805/auc_table.csv")
...
precision_table
write.csv(precision_table, "~/Documents/R/EMTAB2805/precision_table.csv")
...
complexity_table
write.csv(complexity_table, "~/Documents/R/EMTAB2805/complexity_table.csv")


pdf("~/Documents/R/EMTAB2805/Speed.pdf")
boxplot(speed_table, main = "Speed" , xlab = "Methods", ylab = "Speed", col=c("DarkSalmon", "CadetBlue", "Darkkhaki", "DarkSeaGreen", "Thistle"))
dev.off()

pdf("~/Documents/R/EMTAB2805/AUC.pdf")
...
pdf("~/Documents/R/EMTAB2805/Precision.pdf")
...
pdf("~/Documents/R/EMTAB2805/Complexity.pdf")
